...
public class PracticeFormStepDefs {
    ...
    public void bir_dosya_yukler() {
      ...
      //  String filePath =homeDirectory+"Desktop\\Yeni OpenDocument Hesap Tablosu.ods";
       // practiceFormPage.chooseFile.sendKeys(filePath);
String dosya="C:\\Users\\Kullanıcı\\Desktop\\Yeni OpenDocument Hesap Tablosu.ods";
practiceFormPage.chooseFile.sendKeys(dosya);
    ...
    public void dosyaninYuklendiginiDogru() {

     //   Assert.assertTrue(!practiceFormPage.doyaDogrula.getText().contains("No Value for password"));
